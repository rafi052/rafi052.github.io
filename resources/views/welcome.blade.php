...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.folio', 'Portofolio') }}</title>
    ...
    <body class="antialiased">
      ...
      <p class="lead">Freelance | Web & Desainer</p>
                    ...
                    <p>Created with <i class="bi bi-balloon-heart-fill text-denger"></i> by <a href="https://www.instagram.com/raf_0864/" class="text-black fw-bold">Rafi Adji</a></p>
                    </div>
                </div>
            </div>
        </div>
